...
import com.tufer.factory.model.db.view.UserSampleModel;
...
public class UserHelper {
    ...
    public static Call search(String name, final DataSource.Callback<List<UserCard>> callback) {
        RemoteService service = Network.remote();
        Call<RspModel<List<UserCard>>> call = (Call<RspModel<List<UserCard>>>) service.userSearch(name);
    ...
    public static void follow(String id, final DataSource.Callback<UserCard> callback) {
        RemoteService service = Network.remote();
        Call<RspModel<UserCard>> call = (Call<RspModel<UserCard>>) service.userFollow(id);
